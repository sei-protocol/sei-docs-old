...
<Callout type="info" emoji={<Icon icon="shield-lock" className="h-5 w-5 mt-1" />}>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
  <a href="/evm/reference" className="group flex flex-col  p-5 bg-neutral-900/5 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-800/50 hover:bg-white dark:hover:bg-neutral-900 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-md transition-all h-full">
    <div className="w-10 h-10  bg-neutral-900/10 dark:bg-neutral-800/30 flex items-center justify-center mb-4 group-hover:bg-sei-maroon-100/10 transition-colors">
      <Icon icon="info-circle" className="h-5 w-5 text-neutral-700 dark:text-neutral-300 group-hover:text-sei-maroon-100 transition-colors" />
    </div>
...
<a href="/learn/dev-gas" className="group flex flex-col  p-5 bg-neutral-900/5 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-800/50 hover:bg-white dark:hover:bg-neutral-900 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-md transition-all h-full">
  <div className="w-10 h-10  bg-neutral-900/10 dark:bg-neutral-800/30 flex items-center justify-center mb-4 group-hover:bg-sei-maroon-100/10 transition-colors">
    <Icon icon="coins" className="h-5 w-5 text-neutral-700 dark:text-neutral-300 group-hover:text-sei-maroon-100 transition-colors" />
  </div>
  ...
  <a href="/learn/accounts" className="group flex flex-col  p-5 bg-neutral-900/5 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-800/50 hover:bg-white dark:hover:bg-neutral-900 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-md transition-all h-full">
    <div className="w-10 h-10  bg-neutral-900/10 dark:bg-neutral-800/30 flex items-center justify-center mb-4 group-hover:bg-sei-maroon-100/10 transition-colors">
      <Icon icon="user-circle" className="h-5 w-5 text-neutral-700 dark:text-neutral-300 group-hover:text-sei-maroon-100 transition-colors" />
    </div>
