...
keywords: ['chainlink', 'oracle', 'data streams', 'price feeds', 'real-time data', 'sei']
---
...
<Info>You need to contact Chainlink for getting access to API credentials of Data Streams.</Info>
...
- **VerifierProxy contract address** on [Sei mainnet/testnet](https://docs.chain.link/data-streams/crypto-streams?page=1&testnetPage=1#overview): [`0x60fAa7faC949aF392DFc858F5d97E3EEfa07E9EB`](https://seiscan.io/address/0x60fAa7faC949aF392DFc858F5d97E3EEfa07E9EB)
