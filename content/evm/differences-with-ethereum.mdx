  ...
  <table className="w-full divide-y divide-neutral-200 dark:divide-neutral-800">
    ...
    <tbody className="divide-y divide-neutral-200 dark:divide-neutral-800">
      ...
      <tr>
        ...
        <td className="px-4 py-3 text-sm text-green-600 dark:text-green-400 whitespace-nowrap">12.5 M (block cap)</td>
        <td className="px-4 py-3 text-sm text-neutral-600 dark:text-neutral-400 whitespace-nowrap">60 M (block); ~16.7 M per-tx (EIP-7825)</td>
      </tr>
      <tr>
        <td className="px-4 py-3 text-sm text-neutral-900 dark:text-neutral-100 whitespace-nowrap font-medium">Per-Tx Gas Cap</td>
        <td className="px-4 py-3 text-sm text-green-600 dark:text-green-400 whitespace-nowrap">12.5 M (block limit)</td>
      ...
      <tr>
        ...
        <td className="px-4 py-3 text-sm text-green-600 dark:text-green-400">72k (on-chain param, governance-adjustable)</td>
  ...
  <table className="w-full divide-y divide-neutral-200 dark:divide-neutral-800">
    ...
    <tbody className="divide-y divide-neutral-200 dark:divide-neutral-800">
      ...
      <tr>
        ...
        <td className="px-4 py-3 text-sm text-green-600 dark:text-green-400 whitespace-nowrap">= 12,500,000 per block</td>
        <td className="px-4 py-3 text-sm text-neutral-600 dark:text-neutral-400 whitespace-nowrap">= 60,000,000 per block</td>
