...
description: "Transfer funds across chains using the IBC protocol precompile at address 0x0000000000000000000000000000000000001009."
---
...
<Info>View the IBC precompile source code and the contract ABI [here](https://github.com/sei-protocol/sei-chain/tree/main/precompiles/ibc).</Info>
