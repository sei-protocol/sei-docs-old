...
<Info> To find out all about the governance process on Sei, go to the [governance explainer](/learn/general-governance).</Info>
...
async function voteOnProposal(proposalID: bigint, voteOption: number): Promise<void> {
  ...
  try {
    ...
    console.log(`Transaction hash: ${receipt.hash}`);
    console.log(`View on explorer: https://seiscan.io/tx/${receipt.hash}`);
  } catch (error: any) {
...
This is a test proposal. Vote according to your preference to test the system.`,
    ...
    try {
      ...
      if (!proposalID) {
        ...
        console.log(`   🔗 Transaction: https://seiscan.io/tx/${submitReceipt.hash}`);
        return;
      }
      ...
      console.log('   ✅ Vote cast successfully!');
      console.log(`   🔗 Transaction: https://seiscan.io/tx/${voteTx.hash}`);
      ...
      console.log('   ✅ Weighted vote cast successfully!');
      console.log(`   🔗 Transaction: https://seiscan.io/tx/${weightedTx.hash}`);
      ...
      console.log(`   🔗 Transaction: https://seiscan.io/tx/${depositTx.hash}`);
...
2️⃣  Voting on proposal 42...
   ...
   🔗 Transaction: https://seiscan.io/tx/0x456...def
...
3️⃣  Casting weighted vote on proposal 42...
   ...
   🔗 Transaction: https://seiscan.io/tx/0x789...ghi
...
4️⃣  Adding deposit to proposal 42...
   ...
   🔗 Transaction: https://seiscan.io/tx/0xabc...123
...
async function checkVotingEligibility(userAddress: string): Promise<void> {
  ...
  console.log('   Visit: https://dashboard.sei.io/stake to stake your tokens');
}
```
