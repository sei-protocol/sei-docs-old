...
| `Sponsored transactions failing` | No active subscription | Subscribe to [Pay As You Go plan](https://thirdweb.com/dashboard/settings/billing) |
| `Transaction reverted` | Invalid contract address | Verify contract on [Sei Explorer](https://seiscan.io/) |
