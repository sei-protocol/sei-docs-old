...
<div className="p-6 border border-neutral-200 dark:border-neutral-800  bg-black shadow-sm my-8">
  <div className="text-center font-bold mb-6 text-white text-xl">SeiDB Core</div>

  <div className="grid grid-cols-3 gap-8 mb-8">
    <div className="relative">
      <div className="border-2 border-blue-700/30 dark:border-blue-900/40  p-4">
    ...
    <div className="relative">
      <div className="border-2 border-teal-700/30 dark:border-teal-900/40  p-4">
        <div className="bg-neutral-900 rounded p-3">
  ...
  <div className="border-2 border-indigo-900/40 bg-indigo-950/30  p-6">
