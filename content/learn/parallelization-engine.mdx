...
<Callout type="info" emoji={<Icon icon="rocket" className="h-5 w-5 mt-1" />}>
...
<Callout type="default" emoji={<Icon icon="cpu" className="h-5 w-5 mt-1" />}>
...
<Callout type="default" emoji={<Icon icon="arrows-shuffle" className="h-5 w-5 mt-1" />}>
...
<Callout type="info" emoji={<Icon icon="database" className="h-5 w-5 mt-1" />}>
