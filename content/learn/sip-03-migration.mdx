...
description: 'Practical steps and resources for users migrating during SIP-03, including asset transfer and USDC guidance.'
keywords: ['SIP-03', 'migration', 'asset transfer', 'USDC on Sei', 'Keplr', 'Leap', 'Compass', 'EVM wallet']
---
...
- Governance proposal [Proposal #99](https://www.mintscan.io/sei/proposals/99)
