...
<Tabs items={[`mainnet (pacific-1)`, `testnet (atlantic-2)`]}>
  <Tabs.Tab>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
      ...
      <AppCardV2 title="Mintscan" logoUrl={getLogoUrl('Mintscan')} href="https://www.mintscan.io/sei" description="Comprehensive blockchain explorer and analytics platform for Sei mainnet." />
